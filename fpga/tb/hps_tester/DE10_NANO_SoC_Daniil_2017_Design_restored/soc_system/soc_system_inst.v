	soc_system u0 (
		...
		.button_pio_s1_address                 (<connected-to-button_pio_s1_address>),                 //                  button_pio_s1.address
		.button_pio_s1_write_n                 (<connected-to-button_pio_s1_write_n>),                 //                               .write_n
		.button_pio_s1_writedata               (<connected-to-button_pio_s1_writedata>),               //                               .writedata
		.button_pio_s1_chipselect              (<connected-to-button_pio_s1_chipselect>),              //                               .chipselect
		.button_pio_s1_readdata                (<connected-to-button_pio_s1_readdata>),                //                               .readdata
		...
		.gpio_sig_gpio_direction               (<connected-to-gpio_sig_gpio_direction>),               //                       gpio_sig.gpio_direction
		.gpio_sig_gpio_output_sig              (<connected-to-gpio_sig_gpio_output_sig>),              //                               .gpio_output_sig
		.gpio_sig_gpio_input_sig               (<connected-to-gpio_sig_gpio_input_sig>),               //                               .gpio_input_sig
		...
		.i2c_external_sda_in                   (<connected-to-i2c_external_sda_in>),                   //                   i2c_external.sda_in
		.i2c_external_scl_in                   (<connected-to-i2c_external_scl_in>),                   //                               .scl_in
		.i2c_external_sda_oe                   (<connected-to-i2c_external_sda_oe>),                   //                               .sda_oe
		.i2c_external_scl_oe                   (<connected-to-i2c_external_scl_oe>),                   //                               .scl_oe
		...
		.pwm_sig_writeresponsevalid_n          (<connected-to-pwm_sig_writeresponsevalid_n>),          //                        pwm_sig.writeresponsevalid_n
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                          reset.reset_n
		.select_sig_i2c_select                 (<connected-to-select_sig_i2c_select>),                 //                     select_sig.i2c_select
		.select_sig_pwm_select                 (<connected-to-select_sig_pwm_select>),                 //                               .pwm_select
		.select_sig_spi_select                 (<connected-to-select_sig_spi_select>),                 //                               .spi_select
		.select_sig_uart_select                (<connected-to-select_sig_uart_select>),                //                               .uart_select
