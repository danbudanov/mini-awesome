...
$(MEM_0)_HIERARCHICAL_PATH := nios_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: nios_mem
nios_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
