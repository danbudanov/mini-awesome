...
# File: E:\daniilbu\Documents\fpga_arduino\DE10_NANO_SoC_GHRD\DE10_NANO_SoC_GHRD.tcl
# Generated on: Thu Jun 15 15:05:20 2017
...
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[11]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[12]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[10]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[9]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[8]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[7]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[6]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[5]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[4]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ARDUINO[1]
set_location_assignment PIN_AG16 -to ARDUINO[11]
set_location_assignment PIN_AG13 -to ARDUINO[0]
set_location_assignment PIN_AH11 -to ARDUINO[12]
set_location_assignment PIN_AF15 -to ARDUINO[10]
set_location_assignment PIN_AE15 -to ARDUINO[9]
set_location_assignment PIN_AF17 -to ARDUINO[8]
set_location_assignment PIN_AH8 -to ARDUINO[7]
set_location_assignment PIN_AG8 -to ARDUINO[6]
set_location_assignment PIN_U13 -to ARDUINO[5]
set_location_assignment PIN_U14 -to ARDUINO[4]
set_location_assignment PIN_AG9 -to ARDUINO[3]
set_location_assignment PIN_AG10 -to ARDUINO[2]
set_location_assignment PIN_AF13 -to ARDUINO[1]
